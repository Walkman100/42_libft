...
#    Updated: 2019/05/22 14:03:02 by mcarter          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(NAME): ft_putchar_fd.o ft_putstr_fd.o ft_putendl_fd.o ft_putnbr_fd.o \
         ...
         ft_toupper.o ft_tolower.o ft_strcpy.o ft_strncpy.o ft_strcat.o ft_strncat.o ft_strcmp.o ft_strncmp.o ft_strstr.o ft_strnstr.o
	ar rc $(NAME) $(OFILES)
	ranlib $(NAME)
